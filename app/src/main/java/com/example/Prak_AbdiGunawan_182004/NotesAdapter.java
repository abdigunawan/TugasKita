...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.viewHolder> {
    ...
    public void onBindViewHolder(final NotesAdapter.viewHolder holder, final int position) {
        ...
        holder.date.setText("Deadline : " + arrayList.get(position).getDate());
        ...
        submit.setOnClickListener(new View.OnClickListener() {;
            ...
            public void onClick(View v) {
                if (title.getText().toString().isEmpty()) {
                    ...
                    //updating note
                    database_helper.updateNote(title.getText().toString(), des.getText().toString(), des.getText().toString(), arrayList.get(pos).getID());
